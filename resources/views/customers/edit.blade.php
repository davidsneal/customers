			...
			<form id="form-customer" method="post" action="/admin/customers/create" class="form-horizontal" data-toggle="validator" role="form">
			  ...
			  <fieldset>
			    ...
			    <div class="form-group">
			      ...
			      <div class="col-lg-8">
			        <input value="{{ $customer->first_name }}" type="text" class="form-control" id="first_name" name="first_name" placeholder="First Name" max-length=50>
			      </div>
			    ...
			    <div class="form-group">
			      ...
			      <div class="col-lg-8">
			        <input value="{{ $customer->last_name }}" type="text" class="form-control" id="last_name" name="last_name" placeholder="Last Name" max-length=50 required>
			        <div class="help-block with-errors"></div>
			      </div>
			    </div>
			    <div class="form-group">
			      ...
			      <div class="col-lg-8">
			        <input value="{{ $customer->address_1 }}" type="text" class="form-control" id="address_1" name="address_1" placeholder="Address 1" max-length=50 required>
			        <div class="help-block with-errors"></div>
			      </div>
			    </div>
			    <div class="form-group">
			      ...
			      <div class="col-lg-8">
			        <input  value="{{ $customer->address_2 }}"type="text" class="form-control" id="address_2" name="address_2" placeholder="Address 2" max-length=50>
			        <div class="help-block with-errors"></div>
			      </div>
			    </div>
			    <div class="form-group">
			      ...
			      <div class="col-lg-8">
			        <input value="{{ $customer->town }}" type="text" class="form-control" id="town" name="town" placeholder="Town" max-length=50 required>
			        <div class="help-block with-errors"></div>
			      </div>
			    </div>
			    <div class="form-group">
			      ...
			      <div class="col-lg-8">
			        <input value="{{ $customer->county }}" type="text" class="form-control" id="county" name="county" placeholder="County" max-length=50>
			        <div class="help-block with-errors"></div>
			      </div>
			    </div>
			    <div class="form-group">
			      ...
			      <div class="col-lg-8">
			        <input value="{{ $customer->postcode }}" type="text" class="form-control" id="postcode" name="postcode" placeholder="Postcode" max-length=10 required>
			        <div class="help-block with-errors"></div>
			      </div>
			    </div>
			    <div class="form-group">
